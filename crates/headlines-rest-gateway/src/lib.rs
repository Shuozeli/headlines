...
/// Static OpenAPI/Swagger JSON, embedded at build time. Phase 8 ships a
/// hand-rolled descriptor in `gen/openapi/headlines.v1.swagger.json` (see
/// `docs/implementation-issues.md` `[8]`); the full `buf generate`-emitted
/// spec is intended to replace it once `buf` is available in the build
/// environment.
const OPENAPI_JSON: &str = include_str!("../../../gen/openapi/headlines.v1.swagger.json");
